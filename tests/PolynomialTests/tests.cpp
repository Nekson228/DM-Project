...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest1) {
...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest2) {
...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest3) {
...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest4) {
    std::vector<Rational> coef1 = {Rational(2, 3), Rational(-5, 4)};
    Polynomial p1 = Polynomial(coef1);
...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest5) {
...
TEST(Damakin_Roman_2384, PolynomialMultiplicationTest6) {
